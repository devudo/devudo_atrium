 ...
 * on Wed, 23 Jan 2013 17:46:13 -0600.
 *
 ...
 */
  ...
  */
  ...
  $conf['file_directory_path'] = 'sites/atrium.devudo.com/files';
  $conf['file_directory_temp'] = 'sites/atrium.devudo.com/private/temp';
    $conf['clean_url'] = 1;
  $conf['aegir_api'] = 0;
...
# Extra configuration from modules:
  ...
  */
  ...
  if (file_exists('/var/aegir/platforms/openatrium-6.x-1.5/sites/atrium.devudo.com/local.settings.php')) {
    include_once('/var/aegir/platforms/openatrium-6.x-1.5/sites/atrium.devudo.com/local.settings.php');
  }
