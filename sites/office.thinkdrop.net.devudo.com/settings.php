 ...
 * on Wed, 26 Sep 2012 14:56:26 -0500.
 *
 ...
 */
  ...
  */
  ...
  $conf['file_directory_path'] = 'sites/office.thinkdrop.net.devudo.com/files';
  $conf['file_directory_temp'] = 'sites/office.thinkdrop.net.devudo.com/private/temp';
    $conf['clean_url'] = 1;
  $conf['aegir_api'] = 1;
...
# Extra configuration from modules:
  ...
  */
  ...
  if (file_exists('/var/aegir/platforms/openatrium-6.x-1.5/sites/office.thinkdrop.net.devudo.com/local.settings.php')) {
    include_once('/var/aegir/platforms/openatrium-6.x-1.5/sites/office.thinkdrop.net.devudo.com/local.settings.php');
  }
