 ...
 * on Thu, 27 Sep 2012 22:25:12 +0000.
 *
 ...
 */
  ...
  */
  ...
  $conf['file_directory_path'] = 'sites/office.thinkdrop.net/files';
  $conf['file_directory_temp'] = 'sites/office.thinkdrop.net/private/temp';
    $conf['clean_url'] = 1;
  $conf['aegir_api'] = 1;
...
# Extra configuration from modules:
  ...
  */
  ...
  if (file_exists('/var/aegir/platforms/openatrium-6.x-1.5/sites/office.thinkdrop.net/local.settings.php')) {
    include_once('/var/aegir/platforms/openatrium-6.x-1.5/sites/office.thinkdrop.net/local.settings.php');
  }
